<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="首页.aspx.cs" Inherits="MaYiGzsUI.首页" %>
...
<body>
    <form id="form1" runat="server">
        <div id="base" class="">
            ...
            <!-- Unnamed (矩形) -->
            <div id="u31" class="ax_default link_button">
            ...
            <!-- Unnamed (矩形) -->
            <div id="u46" class="ax_default link_button">
            ...
            <!-- Unnamed (矩形) -->
            <div id="u47" class="ax_default link_button">
            ...
            <!-- Unnamed (单选按钮) -->
            <div id="u74" class="ax_default radio_button">
                <label for="u74_input" style="position: absolute; left: 0px;">
                    <div id="u74_text" class="text ">
                        <p><span>记住我方便下次登录</span></p>
                    </div>
                </label>
                <input id="u74_input" type="radio" value="radio" name="u74" />
            </div>

            <!-- Unnamed (矩形) -->
            <div id="u75" class="ax_default link_button">
            ...
            <!-- Unnamed (矩形) -->
            <div id="u80" class="ax_default link_button">
            ...
            <!-- Unnamed (矩形) -->
            <div id="u82" class="ax_default link_button">
            ...
            <div id="u83" class="ax_default label">
                ...
                <div id="u83_text" class="text ">
                    <p><span>·广东高云半导体科技股份有限公司 </span></p>
                    <p><span>·上海霄腾机电设备有限公司</span></p>
                    <p><span>·四川蓝漂日用品有限公司 电商推广</span></p>
                    <p><span>·金帝集团有限公司 经理助理</span></p>
                    <p><span>·杭州银行股份有限公司</span></p>
                    <p><span>·艺星医疗美容集团股份有限公司</span></p>
                    <p><span>·安徽古井集团有限责任公司</span></p>
                    <p><span>
                        <br>
                    </span></p>
                </div>
